                ...
                <div className="list-group">
                  <a href="#" className="list-group-item">
                    <div className="row g-0 align-items-center">
                      <div className="col-2">
                        <img
                          src="/adminkit/dist/img/avatars/avatar-5.jpg"
                  ...
                  <a href="#" className="list-group-item">
                    <div className="row g-0 align-items-center">
                      <div className="col-2">
                        <img
                          src="/adminkit/dist/img/avatars/avatar-2.jpg"
                          className="avatar img-fluid rounded-circle"
                          alt="William Harris"
                        />
                      </div>
                  ...
                  <a href="#" className="list-group-item">
                    <div className="row g-0 align-items-center">
                      <div className="col-2">
                        <img
                          src="/adminkit/dist/img/avatars/avatar-4.jpg"
                          className="avatar img-fluid rounded-circle"
                          alt="Christina Mason"
                        />
                      </div>
                  ...
                  <a href="#" className="list-group-item">
                    <div className="row g-0 align-items-center">
                      <div className="col-2">
                        <img
                          src="/adminkit/dist/img/avatars/avatar-3.jpg"
                          className="avatar img-fluid rounded-circle"
                          alt="Sharon Lessman"
                        />
                      </div>
